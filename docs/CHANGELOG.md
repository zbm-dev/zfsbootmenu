# ZFSBootMenu v2.0.0 (20XX)

ZFSBootMenu 2.0.0 introduces a major internal reorganization that allows images to be built with initramfs generators other than dracut and includes some helpful command-line utilities.
...
* f7a9d96 - README.md: Minor changes to EFI integration steps (Zach Dykstra)
