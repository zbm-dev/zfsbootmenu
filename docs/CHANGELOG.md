...
## ZFSBootMenu v3.0.0 (2024-12-12)

### New features

### Fixes

### Sgnificant commits in this release
...
* 7bda2d5 releng: add Makefile to install Void deps (Zach Dykstra)
...
* 99034d3 docs/index: fix typo (Zach Dykstra)
* 577ef39 testing: add Makefile to install Void deps (Zach Dykstra)
...
* 41739d6 docs/man/zfsbootmenu: additional language for bootfs prop (Zach Dykstra)
* b1c12af docs/guides/alpine/: add zfs-scripts to packages installed (camckay)
* ae6167d docs/index: shorten run-on sentence, fix typo (Zach Dykstra)
* dba1266 docs/guides/ubuntu: note the spartan nature of a basic debootstrap install (Andrew J. Hesford)
* fe37f25 docs/man/zfsbootmenu: document bootfs pool property (Zach Dykstra)
* f3bd51c docs/guides/ubuntu: add redirect for renamed UEFI guide (Zach Dykstra)
* ea82118 docs/guides/ubuntu: fix 22.04 download URL (Zach Dykstra)
* 1615c0a docs/guides/ubuntu: add Noble (24.04) guide (Zach Dykstra)
* 9b17ea4 testing: fix debootstrap for ubuntu (Andrew J. Hesford)
...
* 558cff4 testing: accommodate zstd compression in Arch bootstrap archives (Andrew J. Hesford)
...
* e90bdb7 .github/workflows/build: update artifact actions to v4 (classabbyamp)
...
* 3ca7abc Makefile: make zbm-release the default action (classabbyamp)
* 406cf45 docs/general/mdraid-esp: create guide for redundant ESP with mdraid (classabbyamp)
* b37fff5 docs/general/grub-migration: add grub migration guide (classabbyamp)
* a3645fc github: update default version in bug report template (Zach Dykstra)
* 79c8701 docs/general/portable: default to recovery build (Zach Dykstra)
...
* 0b08977 docs: update copyright date (Zach Dykstra)
* 8f4353e container-building/example: update to match other usages (Zach Dykstra)
* 613f169 docs/guides/: remove loglevel=4 from default KCL (Zach Dykstra)
* d4de213 README.md: fix logo, use latest screenshot (Zach Dykstra)
* 1fad144 docs/guides/chimera/: clean up encrypted install (Zach Dykstra)
...
* 5747d30 docs/guides/chimera/: initial Chimera guide (Zach Dykstra)
* 3b34348 releng/tag-release.sh: no longer ship zbm-kcl as a release asset (Zach Dykstra)
* 0a0d47d docs/CHANGELOG.md: fix uefi booting link (classabbyamp)
* 747535e README.md: fix bootenvs and you link (classabbyamp)
* 2bb1928 docs/manage-redirects.py: add script to manage RTD redirects with the api (classabbyamp)
* 0d992db docs/guides/general/: move to docs/general/ (classabbyamp)
* 173c441 docs/: reorganise logos/images (classabbyamp)
* 49a9b34 docs/: always use venv on void (classabbyamp)
...
* 4de96a0 docs: binary releases helper/documentation (Zach Dykstra)
...
* 3545b26 releng/make-binary.sh: specify release tag in builder images by default (Andrew J. Hesford)
...
* 4db7d29 releng/docker/build-init.sh: add an uption to update packages (Andrew J. Hesford)
* aa8654b zfsbootmenu logs: remove alias, fix header with alt name (Zach Dykstra)
* 89161a8 docs/guides/: re-word pool compatibility note (Zach Dykstra)
...
* 01a2ce6 docs/guides/fedora/: add missing dracut step (Zach Dykstra)
