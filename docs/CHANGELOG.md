...
The dataset defined by `org.zfsbootmenu:keysource` must now be an encrypted dataset. This dataset, by design, must hold encryption keys; it should not effectively be world-readable.
