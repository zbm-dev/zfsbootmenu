...
install:
	...
	install -m 0755 -t $(DESTDIR)/usr/lib/dracut/modules.d/90zfsbootmenu -D 90zfsbootmenu/*.sh
	install -m 0644 -t $(DESTDIR)/usr/lib/dracut/modules.d/90zfsbootmenu -D 90zfsbootmenu/*.conf
	...
	install -m 0755 -t $(DESTDIR)/usr/share/examples/zfsbootmenu/ -D contrib/*
