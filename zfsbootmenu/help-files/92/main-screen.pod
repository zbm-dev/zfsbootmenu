...
[33m[MOD+J][0m [1mjump into chroot[0m
  Enter a chroot of the selected boot environment. The boot environment is mounted
  [33mread/write[0m if the zpool is imported [33mread/write[0m.

[33m[MOD+W][0m [1mimport read/write[0m
  If possible, the pool behind the selected boot environment is exported and then
  re-imported in [33mread/write[0m mode.
